...
SUPPLEMENT_APIS: Dict[str, List[dict]] = {
    ...
    "special_tribunal": [
        ...
        },
        {
            ...
            "request_url": "https://www.law.go.kr/DRF/lawSearch.do?target=acrSpecialDecc",
        ...
        },
        {
            ...
            "request_url": "https://www.law.go.kr/DRF/lawService.do?target=acrSpecialDecc",
            "target": "acrSpecialDecc",
            "api_type": "본문조회",
            "sub_category": "국민권익위원회",
        },
        {
            ...
            "request_url": "https://www.law.go.kr/DRF/lawSearch.do?target=adapSpecialDecc",
        ...
        },
        {
            ...
            "request_url": "https://www.law.go.kr/DRF/lawService.do?target=adapSpecialDecc",
            "target": "adapSpecialDecc",
            "api_type": "본문조회",
            "sub_category": "인사혁신처 소청심사위원회",
        },
